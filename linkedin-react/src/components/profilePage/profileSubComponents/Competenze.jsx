        ...
        <Card className="mb-3">
            <Card.Body>
                <div className="d-flex justify-content-between mb-2">
                    ...
                    <div>
                        <Button className="d-none d-lg-inline rounded-pill" variant="outline-primary">Quiz valutazione competenze</Button>
                        <i style={{cursor:"pointer"}} className="bi bi-plus-lg px-3"></i>
                        <i style={{cursor:"pointer"}} className="bi bi-pencil"></i>                        
                    </div>
                </div>
                <Button className="d-block d-lg-none mb-3 rounded-pill" variant="outline-primary">Quiz valutazione competenze</Button>
                {/* COMPETENZA 1 */}
