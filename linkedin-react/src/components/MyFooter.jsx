        ...
        <Col xs={6} className="footer-col">
          <ul>
            <Col className="firstcol" xs={4}>
              ...
              <li>
                {" "}
                <a href="https://safety.linkedin.com/">Centro sicurezza</a>
              </li>
            </Col>
            ...
            <Col className="secondcol" xs={4}>
              <li>
                {" "}
                <a href="https://it.linkedin.com/accessibility?">
                  {" "}
                  Accessibilità{" "}
                </a>
              </li>
            ...
            <Col className="thirdcol" xs={4}>
              ...
              <li>
                {" "}
                <a href="https://business.linkedin.com/it-it/marketing-solutions/ads?trk=n_nav_ads_f">
                  Pubblicità
                </a>
              </li>
              <li>
                {" "}
                <a href="https://business.linkedin.com/grow?&src=li-footer">
                  Piccole impresa{" "}
                </a>
              </li>
            </Col>
            ...
            <Col xs={10}>
              <h6 className="mb-0">
                <i className="bi bi-shield-shaded">
                  <a href="https://www.linkedin.com/help/linkedin/answer/a1339724">
